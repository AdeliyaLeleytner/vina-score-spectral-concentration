...
The primary analysis excluded three exact experimental ties and evaluated 887 observed
target pairs. With a 0.10-pChEMBL tie tolerance, 824 pairs remained and the qualitative
ordering of representations was unchanged. Pair-weighted accuracies were 0.637 for absolute
Vina, 0.639 for the target-only baseline, 0.545 for column-standardized scores and 0.549 for
two-way residuals. Across 100 posterior multiple imputations, mean per-ligand pairwise
accuracies averaged 0.641, 0.523 and 0.527 for absolute, column-standardized and residual
scores, respectively. These sensitivities do not overcome the six-target scope of the
benchmark.
