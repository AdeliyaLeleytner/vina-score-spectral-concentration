...
| Practical consequence unclear | Expanded the operational benchmark from the dense 74-by-6 spectral block to all 137 strictly matched ligands with at least two observed targets: 38 targets, 691 cells and 2,522 non-tied pairs without activity imputation. Docking imputation/transformation parameters exclude the evaluation cohort; predicted ties receive half credit. Target priors, identity and outcome permutations, scaffold uncertainty, assay restrictions, target deletion, experimental margins, within-cell dispersion and minimum-coverage sensitivities show that higher residual dimension does not guarantee better ranking. Figure 5b shows every score representation with pointwise scaffold intervals. The main operational recommendation is now explicit: validate transformations against priors and stratify by experimental coverage. | Fig. 5; Results; Methods; Discussion; Table S5; evidence ledger |
