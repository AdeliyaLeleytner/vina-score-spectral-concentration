...
Vina pose. Because every scorer sees the same geometry, any difference between their outputs
comes from the function and not from where the molecule was placed. smina 2020.12.10 supplied
