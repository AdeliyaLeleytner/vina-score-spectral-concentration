...
structural baselines: it is within 0.008 of sequence identity and
0.002 of pocket identity, having started 0.12 below. On average precision it remains below
...
PDSP gives the largest point-estimate separation between the two docking maps, but it also exposes
...
its own compound set. We therefore treat the PDSP result as promising but support-sensitive.

Not every receptor in the panel is docked into a human structure, and the sequence baseline is
human throughout. An audit of all 43 PDB accessions finds five non-human receptor chains:
...
The Novartis safety panel provides a chemically non-overlapping test. It covers 12 targets and
