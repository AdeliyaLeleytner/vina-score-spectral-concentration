...
The shared axis appears across the tested scorers. Removing it leaves structured geometry, but that
geometry changes with the ligand library and its external agreement varies by panel
