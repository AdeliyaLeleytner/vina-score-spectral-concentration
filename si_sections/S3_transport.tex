...
a missing pose. The pose is identical across all eight scoring outputs, so differences cannot be
attributed to different selected poses. They are scorer- and implementation-specific differences
at fixed geometry, not differences between independent end-to-end docking pipelines.
