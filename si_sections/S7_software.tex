...
artwork. That target also verifies the repository data and manuscript-source manifests, all
registered result-bundle checksums and the separate 149-row public-core manifest before running
the committed test inventory. This continuous-integration layer becomes meaningful only when
every registered input is present in the committed release candidate.
...
Exploratory five-mode compression & 20260808 \\
...
inputs, including PDSP, SPD, KiRHub and PKIS1 source data, are not all redistributed. The
