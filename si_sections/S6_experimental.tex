...
Two readings of Table~\ref{tab:s6-frozen-predictors} matter. Centred docking approaches sequence
identity on ROC-AUC, 0.7105 against 0.7181, without establishing equivalence, and stays below it
on average precision, 0.3015 against 0.4263; pocket identity is the strongest predictor on average precision at 0.4864.
Its ROC-AUC is 0.0023 above pocket identity, but this point-estimate difference is not an
equivalence or superiority result; on average precision it remains below both structural
baselines. The binary annotations behave
...
the exact- and connectivity-de-overlapped DOCKSTRING support. Source:
...
reflect covariance among targets, and it cannot create new within-ligand ranking information.
